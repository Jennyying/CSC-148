...
def list_all(obj: Union[list, object]) -> list:
    ...
    if not isinstance(obj, list):
        ...
        return gather_lists([list_all(item)
               for item in obj])
...
def max_length(obj: Union[list, object]) -> int:
    ...
    if not isinstance(obj, list):
        ...
        return max([len(obj) if not isinstance(ele, list)
                    else max_length(ele) for ele in obj])
...
def list_over(obj: Union[list, str], n: int) -> List[str]:
    ...
    if isinstance(obj, str):
        ...
        return gather_lists(list_over(ele, n) for ele in obj)
...
def list_even(obj: Union[list, int]) -> List[int]:
    ...
    if isinstance(obj, int):
        ...
        return gather_lists([list_even(ele) for ele in obj])
...
def count_even(obj: Union[list, int]) -> int:
    ...
    if isinstance(obj, int):
        ...
        return sum([count_even(ele) for ele in obj])
...
def count_all(obj: Union[list, object]) -> int:
    ...
    if not isinstance(obj, list):
        ...
        return sum([count_all(ele) for ele in obj])
...
def count_above(obj: Union[list, int], n: int) -> int:
    ...
    if isinstance(obj, int):
        ...
        return sum([count_above(ele, n) for ele in obj])
